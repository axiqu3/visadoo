...
function pageHtml(ev, c, visas, brandColor){
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">'+
    ...
    '<header class="header discover-header"><div class="container nav">'+
      ...
      '<nav class="nav-links" id="navLinks"><a href="/#destinations">Home</a><a href="/events" class="active" aria-current="page">Happenings</a></nav>'+
    ...
    '<footer class="footer home-footer"><div class="container">'+
      '<div class="footer-grid footer-grid--expanded">'+
        ...
        '<div><h5>Explore</h5><ul><li><a href="/">Home</a></li><li><a href="/events">Happenings</a></li><li><a href="/app.html#track">Track application</a></li></ul></div>'+
